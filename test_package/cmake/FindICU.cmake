...
This module reads hints about search results from::
  ...
  ICU_USE_STATIC_LIBS - Set to ON to force the use of the static libraries.  Default is OFF.
...
if(NOT DEFINED ICU_USE_STATIC_LIBS)
...
function(_ICU_FIND)
  ...
  foreach(component ${ICU_FIND_COMPONENTS})
    ...
    if(static_prefix AND ICU_USE_STATIC_LIBS)
      ...
      foreach(component_libname ${component_debug_libnames})
        list(APPEND static_component_debug_libnames
          ${static_prefix}${component_libname})
      endforeach()
      set(component_libnames ${static_component_libnames})
      set(component_debug_libnames ${static_component_debug_libnames})
    endif()
    message( STATUS "
